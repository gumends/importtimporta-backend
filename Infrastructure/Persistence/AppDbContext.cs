...
namespace Infrastructure.Persistence
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<InformacoesProduto> Informacoes_Produtos => Set<InformacoesProduto>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Produto>(entity =>
            {
                ...
                entity.HasOne(p => p.InformacoesProduto)
                    .WithOne()
                    .HasForeignKey<Produto>(p => p.InformacoesProdutoId)
                    .OnDelete(DeleteBehavior.Cascade);
            });



            modelBuilder.Entity<InformacoesProduto>(entity =>
            {
